...
load_template( dirname(__FILE__) . DIRECTORY_SEPARATOR . 'autoloader.php' );
...
load_template( wp_normalize_path(dirname(__FILE__) . '/includes/deprecated.php') );
// Include the ariColor library
// include_once wp_normalize_path(dirname(__FILE__) . '/includes/lib/class-aricolor.php');
load_template( wp_normalize_path(dirname(__FILE__) . '/includes/lib/class-aricolor.php') );
