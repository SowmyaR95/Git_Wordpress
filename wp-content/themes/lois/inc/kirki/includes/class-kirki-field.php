...
if (!class_exists('Kirki_Field')) {
    ...
    class Kirki_Field
    {
        ...
        public function __construct($config_id = 'global', $args = array())
        {
            ...
            $this->kirki_config = trim(esc_html($config_id));
            if ('' === $config_id) {
                $this->kirki_config = 'global';
            }
        ...
        protected function set_kirki_config()
        {
            ...
            $this->kirki_config = esc_html($this->kirki_config);
        ...
        protected function set_option_name()
        {
            ...
            $this->option_name = esc_html($this->option_name);
        ...
        protected function set_capability()
        {
            ...
            $this->capability = trim(esc_html($this->capability));
        }
        ...
        protected function set_settings()
        {
            ...
            foreach ($this->settings as $setting_key => $setting_value) {
                $settings[sanitize_key($setting_key)] = esc_html($setting_value);
                // If we're using serialized options then we need to spice this up.
                if ('option' === $this->option_type && '' !== $this->option_name && (false === strpos($setting_key, '['))) {
                    $settings[sanitize_key($setting_key)] = esc_html($this->option_name) . '[' . esc_html($setting_value) . ']';
                }
            }
