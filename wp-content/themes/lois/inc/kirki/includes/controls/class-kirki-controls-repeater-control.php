    ...
    class Kirki_Controls_Repeater_Control extends Kirki_Customize_Control
    {
        ...
        public function __construct($manager, $id, $args = array())
        {
            ...
            if (isset($args['row_label']) && is_array($args['row_label']) && !empty($args['row_label'])) {
                ...
                if (isset($args['row_label']['field']) && !empty($args['row_label']['field']) && isset($args['fields'][esc_html($args['row_label']['field'])])) {
                ...
                if (isset($value['type']) && ('dropdown-pages' === $value['type'])) {
                    ...
                    $dropdown = wp_dropdown_pages(
                        array(
                            'name' => '',
                            'echo' => 0,
                            'show_option_none' => esc_html($l10n['select-page']),
                            'option_none_value' => '0',
                            'selected' => '',
                        )
                    );
                    ...
                    $dropdown = str_replace('<select', '<select data-field="' . esc_html($args['fields'][$key]['id']) . '"' . $this->get_link(), $dropdown);
        ...
        public function repeater_js_template()
        {
            ...
            <script type="text/html" class="customize-control-repeater-content">
                <# var field; var index = data.index; #>
                    <# data.kirki_config = '<?php echo esc_html($this->kirki_config); ?>'; #>
                                ...
                                <# _.each( data, function( field, i ) { #>
                                                                        ...
                                                                        <# if ( field.label ) { #>
                                                                            ...
                                                                            <# } #>
                                                                                <# if ( field.description ) { #>
                                                                                    <span class="description customize-control-description">{{{ field.description }}}</span>
                                                                                    <# } #>
                                                                                        <div class="customize-control-content repeater-dropdown-pages">
                                                                                            {{{ field.dropdown }}}
                                                                                        </div>
                                                                    </label>
                                                                                                ...
                                                                                                <# if ( field.description ) { #>
                                                                                                    ...
                                                                                                    <# } #>
                                                                                                        <input class="color-picker-hex"
                                                                                                               type="text"
                                                                                                               maxlength="7"
                                                                                                               placeholder="{{ window.kirki.l10n[ data.kirki_config ]['hex-value'] }}"
                                                                                                               value="{{{ field.default }}}"
                                                                                                               data-field="{{{ field.id }}}"
                                                                                                               {{
                                                                                                               defaultValue
                                                                                                    ...
                                                                                                    <# } #>
                                                                                                        ...
                                                                                                        <# } else if ( field.type === 'image' || field.type === 'cropped_image' ) { #>
                                                                                                            ...
                                                                                                            <figure class="kirki-image-attachment"
                                                                                                                    data-placeholder="{{ window.kirki.l10n[ data.kirki_config ]['no-image-selected'] }}">
                                                                                                                <# if ( field.default ) { #>
                                                                                                            ...
                                                                                                            <div class="actions">
                                                                                                                ...
                                                                                                                <button type="button"
                                                                                                                        ...
                                                                                                                        data-label=" {{ window.kirki.l10n[ data.kirki_config ]['add-image'] }}"
                                                                                                                        data-alt-label="{{ window.kirki.l10n[ data.kirki_config ]['change-image'] }}">
                                                                                                                    <# if ( field.default ) { #>
                                                                                                                        {{
                                                                                                                        window.kirki.l10n[
                                                                                                                        data.kirki_config
                                                                                                            ...
                                                                                                            <# } else if ( field.type === 'upload' ) { #>
                                                                                                                ...
                                                                                                                <figure class="kirki-file-attachment"
                                                                                                                        data-placeholder="{{ window.kirki.l10n[ data.kirki_config ]['no-file-selected'] }}">
                                                                                                                    <# if ( field.default ) { #>
                                                                                                                ...
                                                                                                                <div class="actions">
                                                                                                                    ...
                                                                                                                    <button type="button"
                                                                                                                            class="button upload-button"
                                                                                                                            data-label="{{ window.kirki.l10n[ data.kirki_config ]['add-file'] }}"
                                                                                                                            data-alt-label="{{ window.kirki.l10n[ data.kirki_config ]['change-file'] }}">
                                                                                                                        <# if ( field.default ) { #>
                                                                                                                            {{
                                                                                                                            window.kirki.l10n[
                                                                                                                            data.kirki_config
                                    ...
                                    <# }); #>
                                        <button type="button" class="button-link repeater-row-remove">{{
                                            window.kirki.l10n[ data.kirki_config ].remove }}
                                        </button>
                            </div>
                        </li>
            </script>
