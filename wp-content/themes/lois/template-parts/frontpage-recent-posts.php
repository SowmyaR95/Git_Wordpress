...
if (in_array('frontpage_section_order_recent_posts', $lois_frontpage_order)) {
    ...
    <section
        ...
        <div class="light-box-style">
            ...
            <div class="container">
                <div class="row agency-blog-part-02">
                    <?php
                    global $post;
                    $temp = $post;
                    $i = 0;
                    ...
                    foreach ($recent_posts as $post) {
                        setup_postdata($post);
                        ?>
                        <?php if ($i % 3 == 0 && $i != 0) { ?><div class="row agency-blog-part-02"><?php } ?>
                        <div class="col-sm-4 col-md-4 col-xs-12 rabp-wd <?php lois_animate('zoomIn'); ?>"><?php get_template_part('template-parts/entry');
                            $i++; ?></div>
